...
The EnviroHelp platform follows a layered client-server architecture that separates the frontend, backend, authentication, and database layers. This structure improves modularity, maintainability, and scalability.

User Interface Wireframes:

The UI wireframes were designed using Figma to represent the key workflows of the system including login, dashboards, campaign creation, request negotiation, and campaign progress tracking.

Figma Prototype: https://www.figma.com/design/YR0DSIA10sVOWg3uSEn8Dr/EnviroHelp-Wireframes?node-id=1-2&t=6bIwhKCKswVRFF5I-1
